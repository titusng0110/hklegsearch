...
def main():
    ...
    local_model_path = "local_inf_small"

    # Check if model already exists locally, if not download and save it
    if not os.path.exists(local_model_path):
        print(f"Downloading model to {local_model_path}...")
        original_model = SentenceTransformer("infly/inf-retriever-v1-1.5b", trust_remote_code=True, model_kwargs={ "torch_dtype": torch.bfloat16 })
    ...
    df_embeddings.write_parquet("inf_small_embeddings.parquet")
